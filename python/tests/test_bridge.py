...
"""
Tests for the Valoricore Bridge — deterministic proof generation.
...
# Add the python directory to path so we can import valoricore
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))

from valoricore.valoricore_ffi import ingest_embedding, generate_proof, verify_embedding
...
@pytest.fixture
def adapter_pair():
    """Create a MockVectorDB + ValoricoreAdapter with a temp kernel."""
    d = tempfile.mkdtemp(prefix="valoricore_adapter_test_")
