...
class ValoricoreRetriever(BaseRetriever):
    def __init__(self, adapter: ValoricoreAdapter, embed_fn, k: int = 4):
    ...
    def get_relevant_documents(self, query: str) -> List[Document]:
        ...
        # 2. Search via ValoricoreAdapter (handles FXP validation and retries)
        ...
        for hit in hits:
             ...
             # Current Valoricore Node doesn't automatically join chunks yet in V1 search.
