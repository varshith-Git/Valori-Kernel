...
class ValoricoreVectorStore(VectorStore):
    ...
    def __init__(self, adapter: ValoricoreAdapter):
    ...
    def add(self, nodes: List[TextNode], **kwargs: Any) -> List[str]:
        ...
        for node in nodes:
            ...
            # Prep for upsert
            # We store text and metadata in Valoricore metadata for retrieval
            ...
            # Yes. ValoricoreAdapter doesn't wrap upsert_vector yet?
    ...
    def query(self, query: VectorStoreQuery, **kwargs: Any) -> VectorStoreQueryResult:
        ...
        for hit in hits:
             ...
             # Valoricore uses L2 squared distance currently. 
