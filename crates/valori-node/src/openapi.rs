...
use crate::api::{
    ...
    GraphQueryResponse, GraphRagHit, GraphRagProvenance, GraphRagProvenanceEdge, GraphRagResponse,
    GraphRerankRequest, HealthResponse, IndexRebuildRequest, IndexRebuildResponse,
    InsertReceiptJson, InsertRecordRequest, InsertRecordResponse, ListCollectionsResponse,
    ListNodesResponse, MemoryConsolidateRequest, MemoryConsolidateResponse,
    MemoryContradictRequest, MemoryContradictResponse, MemorySearchHit, MemorySearchResponse,
    MemorySearchVectorRequest, MemoryUpsertResponse, MemoryUpsertVectorRequest,
    MetadataGetResponse, MetadataSetRequest, MetadataSetResponse, MultiSearchHit,
    MultiSearchRequest, MultiSearchResponse, NodeInfo, OperationDetails, OperationMetrics,
    OperationOverview, OperationResults, PartialSearchFailure, PoolStatsSchema, RecordResponse,
    RequestId, SearchHit, SearchRequest, SearchResponse, ShardRoutingEntry, ShardRoutingResponse,
    SnapshotRestoreRequest, SnapshotRestoreResponse, SnapshotSaveRequest, SnapshotSaveResponse,
    StateProofResponse, SubgraphEdge, SubgraphNode, SubgraphResponse, TimelineEntry,
    TimelineResponse, UpdateMetadataResponse, UsageResponse, UsageStorage,
};
...
#[openapi(
    ...
    paths(
        ...
        crate::server::verify_assertion,
        crate::server::get_assertion_verification,
        // ── crypto ──────────────────────────────────────────────────────────
    ...
    components(schemas(
        ...
        valori_rag::community::VerifyClaimRequest,
        valori_rag::community::VerificationReceipt,
        valori_rag::community::VerificationOutcome,
        valori_rag::community::StructuredClaim,
        valori_rag::community::AssertionEvidence,
