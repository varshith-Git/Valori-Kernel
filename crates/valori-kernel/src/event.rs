...
pub enum KernelEvent {
    ...
    AutoCreateNamespace { name: alloc::string::String },
        ...
        S: Serializer,
    {
        match self {
            KernelEvent::InsertRecord {
                ...
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 0, "InsertRecord", 4)?;
            ...
            KernelEvent::DeleteRecord { id } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 1, "DeleteRecord", 1)?;
                state.serialize_field("id", id)?;
                state.end()
            }
            KernelEvent::CreateNode { id, kind, record } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 2, "CreateNode", 3)?;
                state.serialize_field("id", id)?;
            ...
            KernelEvent::CreateEdge { id, from, to, kind } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 3, "CreateEdge", 4)?;
                state.serialize_field("id", id)?;
            ...
            KernelEvent::DeleteEdge { id } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 4, "DeleteEdge", 1)?;
                state.serialize_field("id", id)?;
                state.end()
            }
            KernelEvent::SoftDeleteRecord { id } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 5, "SoftDeleteRecord", 1)?;
                state.serialize_field("id", id)?;
                state.end()
            }
            KernelEvent::DeleteNode { id } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 6, "DeleteNode", 1)?;
                state.serialize_field("id", id)?;
                state.end()
            }
            ...
            KernelEvent::ShredKey { key_id } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 8, "ShredKey", 1)?;
                state.serialize_field("key_id", key_id)?;
                state.end()
            }
            KernelEvent::AutoInsertRecord {
                ...
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 9, "AutoInsertRecord", 3)?;
                state.serialize_field("vector", vector)?;
            ...
            KernelEvent::AutoCreateNode { kind, record } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 10, "AutoCreateNode", 2)?;
                state.serialize_field("kind", kind)?;
                state.serialize_field("record", record)?;
                state.end()
            }
            KernelEvent::AutoCreateEdge { from, to, kind } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 11, "AutoCreateEdge", 3)?;
                state.serialize_field("from", from)?;
                state.serialize_field("to", to)?;
                state.serialize_field("kind", kind)?;
                state.end()
            ...
            KernelEvent::SetMeta { key, value } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 13, "SetMeta", 2)?;
            ...
            KernelEvent::DropNamespace { name } => {
                let mut state =
                    serializer.serialize_struct_variant("KernelEvent", 15, "DropNamespace", 1)?;
                state.serialize_field("name", name)?;
                state.end()
            }
...
impl<'de> Deserialize<'de> for KernelEvent {
        ...
        Deser: Deserializer<'de>,
    {
        ...
        Ok(match helper {
            KernelEventHelper::InsertRecord {
                id,
                vector,
                metadata,
                tag,
            ...
            KernelEventHelper::CreateNode { id, kind, record } => {
                KernelEvent::CreateNode { id, kind, record }
            }
            KernelEventHelper::CreateEdge { id, from, to, kind } => {
                KernelEvent::CreateEdge { id, from, to, kind }
            }
            ...
            KernelEventHelper::InsertRecordEncrypted {
                id,
                key_id,
                ciphertext,
                metadata_ciphertext,
            ...
            KernelEventHelper::AutoInsertRecord {
                vector,
                metadata,
                tag,
            } => KernelEvent::AutoInsertRecord {
            ...
            KernelEventHelper::AutoInsertRecordEncrypted {
                namespace_id,
                key_id,
                ciphertext,
                tag,
            ...
            KernelEventHelper::AutoCreateNamespace { name } => {
                KernelEvent::AutoCreateNamespace { name }
            }
        ...
        D: Deserializer<'de>,
    {
        ...
        impl<'de> Visitor<'de> for MetadataVisitor {
                ...
                A: SeqAccess<'de>,
            {
                ...
                let bytes: alloc::vec::Vec<u8> = seq
                    .next_element()?
...
mod tests {
    ...
    fn test_event_roundtrip() {
        ...
        assert_eq!(
            original, decoded,
            "Event must survive serialization roundtrip"
        );
    }

    #[test]
    fn test_auto_create_namespace_roundtrip() {
        let original = KernelEvent::AutoCreateNamespace {
    ...
    fn test_drop_namespace_by_name_roundtrip() {
        let original = KernelEvent::DropNamespace {
            name: "tenant-acme".into(),
        };
        let bytes = bincode::serde::encode_to_vec(&original, bincode::config::standard()).unwrap();
        let (decoded, _): (KernelEvent, _) =
    ...
    fn test_namespace_events_serialization_determinism() {
        let create = KernelEvent::AutoCreateNamespace {
            name: "docs".into(),
        };
        ...
        let drop = KernelEvent::DropNamespace {
            name: "docs".into(),
        };
