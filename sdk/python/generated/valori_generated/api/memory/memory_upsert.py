...
def sync_detailed(
    *,
    ...
    """Store an agent memory
     ...
     Inserts the vector and links it into the knowledge graph as a chunk node under a document node,
    returning both ids alongside a stable `memory_id`.
