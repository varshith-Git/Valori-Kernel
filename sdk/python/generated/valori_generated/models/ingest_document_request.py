...
T = TypeVar("T", bound="IngestDocumentRequest")
...
class IngestDocumentRequest:
    ...
    Attributes:
        ...
        chunk_overlap (Union[None, Unset, int]): Fixed-strategy overlap in chars (default 200).
        chunk_size (Union[None, Unset, int]): Fixed-strategy chunk size in chars (default 1000).
        collection (Union[None, Unset, str]): Collection to ingest into (default = "default").
        source (Union[None, Unset, str]): Source label stored in metadata (e.g. filename). Optional.
        strategy (Union[None, Unset, str]): Chunking strategy: `auto` | `tree` | `conversation` | `sentence` | `fixed`.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ingest_document_request.additional_properties = d
        return ingest_document_request
