...
T = TypeVar("T", bound="MetadataSetRequestMetadata")


@_attrs_define
class MetadataSetRequestMetadata:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        metadata_set_request_metadata = cls()

        metadata_set_request_metadata.additional_properties = d
        return metadata_set_request_metadata
