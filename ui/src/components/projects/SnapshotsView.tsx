...
// multi-tenancy (projectId-scoped routes) and trimmed for the hosted
// model: kernel's project-switcher (multi-project, same machine) and
// "save locally to a filesystem path" / "local files" sections don't apply
// here — there's no filesystem shared between the browser and a project's
// remote node. Cloud (object store) save/restore and binary download,
// which are real network operations against the node, are unchanged.
